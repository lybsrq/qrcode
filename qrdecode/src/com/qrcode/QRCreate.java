...
public class QRCreate {
    ...
    public static void main(String[] args) {
        // 生成二维码
        BufferedImage qrCode = QrcodeImage("https://www.baidu.com"); // 放入url
        writeImage(qrCode, "/Users/liyongbao/Downloads/qecode2.png");

        // 生成带有图片logo的二维码
        File qrcode = new File("/Users/liyongbao/Downloads/qecode2.png");
        File logo = new File("/Users/liyongbao/Downloads/logo.png");
        BufferedImage logoQrcode = encodeImgLogo(qrcode, logo);
        writeImage(logoQrcode, "/Users/liyongbao/Downloads/logQrcode.png");
    }
}
